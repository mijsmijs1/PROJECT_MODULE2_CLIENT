...
import { loginWithGoogle, loginWithGithub, reauthenticate } from '@services/firebase'
export default function Login({ loadFlag, setLoadFlag }) {
    ...
    async function handleLogin(e) {
        ...
        try {
            let data = {
                ...
                password: e.target.passworLogin.value
            }
    ...
    return (
        <form
            ...
            style={{ display: !loadFlag ? "flex" : "none" }} className="form_container">
            ...
            <div className="title_container">
                ...
                <span className="subtitle sign_up">
                    Don't have an account? <span onClick={() => { setLoadFlag(true) }}>Sign up.</span>
                </span>
            </div>
            <br />
            ...
            <button
                ...
                type='button'
                title="Sign In" className="sign-in_apl">
